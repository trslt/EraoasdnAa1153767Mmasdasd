...
import { useQuery, getLesson, getLessonContent } from 'wasp/client/operations';
...
export default function LessonEditAdminPage({ user }: { user: AuthUser }) {
  ...
  const { data: lessonContent, isLoading } = useQuery(getLessonContent, { lessonId, lang: 'en' });
