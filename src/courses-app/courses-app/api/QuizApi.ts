...
export const createQuiz: CreateQuiz<{}, Quiz> = async (req, res, context) => {
...
export const updateQuiz: UpdateQuiz<{}, Quiz> = async (req, res, context) => {
...
export const deleteQuiz: DeleteQuiz<{}, {}> = async (req, res, context) => {
